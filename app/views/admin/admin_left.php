        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span><?=Hl::$t->_('Tour galychyna')?></span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3><?=Hl::$t->_('Main')?></h3>
                <?php foreach($aTables as $t) { ?>
                <ul class="nav side-menu">
                  <li>
                    <a href="<?=strlen($t['adm_link'])>0?$t['adm_link']:$t['name']?>"
                       onclick="return getContent(this)"
                       id="menu_<?=$t['name']?>">
                      <i class="<?=(strlen($t['img'])>3)?$t['img']:'fa fa-home'?>"></i>
                      <?=$t['note'.Hl::$pstfx]?>
                      <!--span class="fa fa-chevron-down"></span-->
                    </a>
                    <!--ul class="nav child_menu">
                      <li><a href="<?=$t['name']?>"
                             onclick="return getContent(this)">Show all</a></li>
                      <li><a href="<?=$t['name']?>/new"
                             onclick="return getContent(this)">Add</a></li>
                    </ul-->
                  </li>
                </ul>
                <?php } ?>
